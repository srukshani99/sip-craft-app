...
describe('ItemList Component', () => {
  const mockCocktails: CocktailItem[] = [
    { id: '1', name: 'Kiwi Lemon', category: 'Cocktail', image: '/kiwilemon.jpg', isFavourite: false },
    { id: '2', name: 'Strawberry Shivers', category: 'Cocktail', image: '/strawberryshivers.jpg', isFavourite: false },
  ];
  ...
  it('calls handleRefresh and fetches new random cocktails', async () => {
    const newCocktails: CocktailItem[] = [
      { id: '3', name: 'Blue Bird', category: 'Cocktail', image: '/bluebird.jpg', isFavourite: false },
    ];
